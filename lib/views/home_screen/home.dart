...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var navBarItem =[ 
      BottomNavigationBarItem(icon: Image.asset(icHome,width: 26,),label: 'Главная'),
      BottomNavigationBarItem(icon: Image.asset(icCategories,width: 26,),label: 'Категории'),
      BottomNavigationBarItem(icon: Image.asset(icCart,width: 26,),label: 'Корзина'),
      BottomNavigationBarItem(icon: Image.asset(icProfile,width: 26,),label: 'Профль'),
    ];
